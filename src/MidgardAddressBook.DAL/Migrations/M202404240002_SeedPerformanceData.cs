...
public class M202404240002_SeedPerformanceData : Migration
{
    ...
    private const string UpSql = """
        ...
        VALUES
            ('First0', 'Last0', 'user0@example.com', '0 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000000', NOW() - INTERVAL '0 days'),
            ('First1', 'Last1', 'user1@example.com', '1 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000001', NOW() - INTERVAL '1 days'),
            ('First2', 'Last2', 'user2@example.com', '2 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000002', NOW() - INTERVAL '2 days'),
            ('First3', 'Last3', 'user3@example.com', '3 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000003', NOW() - INTERVAL '3 days'),
            ('First4', 'Last4', 'user4@example.com', '4 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000004', NOW() - INTERVAL '4 days'),
            ('First5', 'Last5', 'user5@example.com', '5 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000005', NOW() - INTERVAL '5 days'),
            ('First6', 'Last6', 'user6@example.com', '6 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000006', NOW() - INTERVAL '6 days'),
            ('First7', 'Last7', 'user7@example.com', '7 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000007', NOW() - INTERVAL '7 days'),
            ('First8', 'Last8', 'user8@example.com', '8 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000008', NOW() - INTERVAL '8 days'),
            ('First9', 'Last9', 'user9@example.com', '9 Test Street', NULL, 'NY', 'Midgard', '10001', '555-0000009', NOW() - INTERVAL '9 days');
        """;
}
